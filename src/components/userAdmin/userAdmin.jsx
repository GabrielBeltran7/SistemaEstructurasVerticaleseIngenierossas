...
//   const handleUserChangeState = (userId, value) => {
//     setEstado({ id: userId, estado: value });
//     dispatch(UpdateUserChangeState({ id: userId, estado: value }));
//   };
...
//   const handleUserChange = (userId, value) => {
//     setUserState((prev) => ({ ...prev, [userId]: value }));
//     dispatch(apdateStateUser({ id: userId, user: value }));
//   };
...
//       <SearchOutlined style={{ color: filtered ? "#1677ff" : undefined }} />
//     ),
//     onFilter: (value, record) => (record[dataIndex]?.toString().toLowerCase().includes(value.toLowerCase())) || false,
//     onFilterDropdownOpenChange: (visible) => {
//       if (visible) {
//         setTimeout(() => searchInput.current?.select(), 100);
//       }
...
//       render: (text, record) => (
//         <a href={`/componentUpdateUserAdmin/${record.id}`}>{text}</a>
//       ),
//     },
//     { title: "Apellido", dataIndex: "apellidos", key: "apellidos", ...getColumnSearchProps("apellidos") },
//     { title: "Telefono", dataIndex: "telefono", key: "telefono", ...getColumnSearchProps("telefono") },
...
//         </div>
//       </div>
//       <Table columns={columns} dataSource={formattedUsers} />
//       <div>
//         <div className={style.containerAviso}></div>
//       </div>
//     </div>
...
//     dispatch(UpdateUserChangeState({id:userId,
//       estado:value})
//     );
...
//       dataIndex: "educacion",
//       key: "educacion",
//       ...getColumnSearchProps("educacion"),
//     },
//     {
//       title: "N° Targeta Proesional",
//       dataIndex: "numerotarjetaprofesional",
//       key: "numerotarjetaprofesional",
//       ...getColumnSearchProps("numerotarjetaprofesional"),
//     },
//     {
//       title: "Cargo",
//       dataIndex: "cargo",
